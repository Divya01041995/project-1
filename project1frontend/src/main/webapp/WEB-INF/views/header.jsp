		...
		<div class="collapse navbar-collapse" id="collapse-example">
			...
			<li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown">Select by Category<b class="caret"></b></a>
				<ul class="dropdown-menu" role="menubar">
					<li>
						<a href='<c:url value="/all/searchbycategory?searchCondition=Lakme"></c:url>'>Lakme</a>
						<a href='<c:url value="/all/searchbycategory?searchCondition=Loreal"></c:url>'>L'Oreal</a>		
						<a href='<c:url value="/all/searchbycategory?searchCondition=MAC"></c:url>'>MAC</a>					
					</li>
				</ul>
			</li>
